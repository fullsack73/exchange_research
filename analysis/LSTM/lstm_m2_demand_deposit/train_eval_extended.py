...
OUT_DIR = BASE_DIR / "analysis" / "LSTM" / "lstm_m2_demand_deposit"
DATA_PATH = OUT_DIR / "daily_dataset_m2_demand_deposit.csv"
    ...
    preds = pd.DataFrame(
        {
            ...
            "pred_counterfactual_flat_m2": pred_cf_true,
        }
    )
...
def main() -> None:
    ...
    block_metrics = []
    all_preds = []
    flat_m2_value = float(train_df[TARGET_M2_COL].iloc[-1])
