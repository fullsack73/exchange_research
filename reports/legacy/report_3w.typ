...
- 김예정: 환율 결정에 대한 이론적 배경을 조사 및 정리하였음. \
- 김한별: 데이터 수집 및 전처리 과정을 수행하였으며, 랜덤 포레스트와 SHAP 활용 분석을 실시 및 그 결과를 시각화하여 정리하였음. \
- 이유준: 가산 금리와 한미 금리차가 환율 변동에 미치는 영향에 대한 경제적 해석을 제시하여 분석 및 검증의 방향을 제시하였음.  \
- 이지은: 최근 이상 구간에서의 환율 변동의 원인에 대하여 한국 및 미국의 정치적 상황 등 외부적 요인들을 조사하여 분석에 반영하였음. \
