...
#figure(
  rect(width: 90%, height: 180pt, stroke: 1pt + gray)[
    #align(center + horizon)[
      #text(fill: gray)[[ 그림 삽입 위치: 환율 및 주요 변수 상관관계 히트맵 ]]
      #v(0.5em)
      #text(size: 9pt, fill: gray)[파일: exchange_rate_heatmap.png]
    ]
  ],
  caption: [환율 및 주요 변수 상관관계 히트맵 (전체 기간)]
)
...
#figure(
  rect(width: 90%, height: 160pt, stroke: 1pt + gray)[
    #align(center + horizon)[
      #text(fill: gray)[[ 그림 삽입 위치: SHAP 기여도 요약 플롯 ]]
      #v(0.5em)
      #text(size: 9pt, fill: gray)[파일: shap_summary_anomaly.png]
    ]
  ],
...
#figure(
  rect(width: 90%, height: 160pt, stroke: 1pt + gray)[
    #align(center + horizon)[
      #text(fill: gray)[[ 그림 삽입 위치: Counterfactual Simulation 결과 ]]
      #v(0.5em)
      #text(size: 9pt, fill: gray)[파일: counterfactual_simulation.png]
    ]
  ],
  caption: [Counterfactual Simulation 결과: MMF 고정 시 환율 예측 변화]
)
...
#figure(
  rect(width: 90%, height: 160pt, stroke: 1pt + gray)[
    #align(center + horizon)[
      #text(fill: gray)[[ 그림 삽입 위치: Hybrid 모델 예측 결과 그래프 ]]
      #v(0.5em)
      #text(size: 9pt, fill: gray)[파일: full_1995_2026_5_day_forecast_samples.png]
    ]
  ],
